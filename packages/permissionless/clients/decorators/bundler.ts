...
export type BundlerActions<entryPoint extends EntryPoint = DefaultEntryPoint> =
    {
        ...
        getUserOperationByHash: (
            ...
            GetUserOperationByHashReturnType<entryPoint>
        > | null>
        /**
         *
...
const bundlerActions = <entryPoint extends EntryPoint = DefaultEntryPoint>(
    client: Client
): BundlerActions<entryPoint> => ({
    sendUserOperation: async (
        args: SendUserOperationParameters<entryPoint>
    ): Promise<Hash> =>
        sendUserOperation<entryPoint>(client as BundlerClient, args),
    estimateUserOperationGas: <
        entryPoint extends EntryPoint = DefaultEntryPoint
    >(
        args: EstimateUserOperationGasParameters<entryPoint>,
        stateOverrides?: StateOverrides
    ) =>
    ...
    getUserOperationByHash: (args: GetUserOperationByHashParameters) =>
        getUserOperationByHash<entryPoint>(client as BundlerClient, args),
